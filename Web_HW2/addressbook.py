...
class Record(ViewAbcInterface):
    def view_console(self):
        # this method is the same as __repr__
        # Implemented to satisfy Homework requirements, but not useful in this project
...
# Class was created due to homework requirements in Python Core module
